...
RandomExtensions.maketype(W::TruncatedBigWittRing, _,_)=elem_type(W)
function RandomExtensions.make(W::TruncatedBigWittRing, vs...)
   R = base_ring(W)
...
rand(rng::AbstractRNG, W::TruncatedBigWittRing, v...) = rand(rng, RandomExtensions.make(W,v...))
rand(W::TruncatedBigWittRing{AbstractAlgebra.GFElem{Int64}},_)=rand(W)
rand(W::TruncatedBigWittRing,v...)=rand(Random.GLOBAL_RNG,W,v...)
#################
#Promotion Rules#
#################
